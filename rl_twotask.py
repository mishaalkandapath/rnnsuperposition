...
from rnn import RNN
from datasets import TwoStepRLEnvironment   
...
def signal_handler(signum, frame):
    ...
    if train_obj_global is not None and run_name_global is not None:
        try:
            os.makedirs(f"models/rl_train/{run_name_global}", exist_ok=True)
            save_path = f"models/rl_train/{run_name_global}/interrupted_{run_name_global}.ckpt"
...
if __name__ =="__main__":
    ...
    os.makedirs(f"models/rl_train/{args.run_name}", exist_ok=True)
    run = wandb.init(
